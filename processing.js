var fillColor, strokeColor, strokeweight,
            ...
            line = function(x1, y1, x2, y2) {
                document.body.innerHTML += 
                    '<svg width="' + width + '" height="' + height + '" style="position: absolute; left: 0; top: 0;">' +
                        '<line x1="' + x1 + '" y1=' + y1 + '" x2="' + x2 + '" y2="' + y2 + '" style="stroke: ' + strokeColor + '; stroke-width: ' + strokeweight + ';" />' +
                    '</svg>'
                ;
            },
            triangle = function(x1, y1, x2, y2, x3, y3) {
                document.body.innerHTML +=
                    '<svg width="' + width + '" height="' + height + '" style="position: absolute; left: 0; top: 0;">' + 
                        '<polygon points="' + x1 + ',' + y1 + ' ' + x2 + ',' + y2 + ' ' + x3 + ',' + y3 + '" style="fill: ' + fillColor + '; stroke: ' + strokeColor + '; stroke-width: ' + strokeweight + ';" />' +
                    '</svg>'
            },
            quad = function(x1, y1, x2, y2, x3, y3, x4, y4) {
                document.body.innerHTML +=
                    '<svg width="' + width + '" height="' + height + '" style="position: absolute; left: 0; top: 0;">' + 
                        '<polygon points="' + x1 + ',' + y1 + ' ' + x2 + ',' + y2 + ' ' + x3 + ',' + y3 + ' ' + x4 + ',' + y4 + '" style="fill: ' + fillColor + '; stroke: ' + strokeColor + '; stroke-width: ' + strokeweight + ';" />' +
                    '</svg>'
            },
            debug = function() {
